...
public class DefaultCatalog extends CatalogImpl {
    ...
    /**
     * The schema <code>AthleticProByVeronica</code>.
     */
    public final Athleticprobyveronica ATHLETICPROBYVERONICA = Athleticprobyveronica.ATHLETICPROBYVERONICA;
    ...
    public final List<Schema> getSchemas() {
        return Arrays.asList(
            Athleticprobyveronica.ATHLETICPROBYVERONICA
        );
    }
